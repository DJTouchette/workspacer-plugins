...
| 🚢 **Shiplight** | [`workspacer-plugin-shiplight`](https://github.com/DJTouchette/workspacer-plugin-shiplight) | Running pipelines and open PRs at a glance (GitHub + Azure DevOps) — one status lamp, live runs, review states, and notifications on verdicts. |
